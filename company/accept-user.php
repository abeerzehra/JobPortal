...
try {
    ...
    $mail->Username   = 'abeer.zehra92@gmail.com';                     // SMTP username
    $mail->Password   = 'Dangling92';                               // SMTP password
    ...
    $mail->Body    = '<h1>Congratulations your application for job has been accepted!!<h1/>';
    $mail->AltBody = '---------';
