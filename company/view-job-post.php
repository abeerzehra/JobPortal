            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li><a href="view-job-applications.php"><i class="fa fa-newspaper-o"></i>View Applications</a></li>
               ...
               $sql = "SELECT * FROM job_post WHERE id_company='$_SESSION[id_user]' AND id_jobpost='$_GET[id]'";
                ...
                <div class="pull-right">
                 ...
                 <div class="pull-right" style="margin-right: 10px;">
                  <a href="delete-job-post.php?id=<?php echo $row['id_jobpost']; ?>" class="btn btn-danger btn-lg btn-flat margin-top-20"><i class="fa fa-trash"></i> Delete</a>
                </div>
                <div class="pull-right" style="margin-right: 10px;">
                  <a href="edit-job-post.php?id=<?php echo $row['id_jobpost']; ?>" class="btn btn-primary btn-lg btn-flat margin-top-20"><i class="fa fa-edit"></i> Edit</a>
                </div>
