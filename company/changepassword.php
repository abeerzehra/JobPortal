...
if(isset($_POST)) {
	...
	$sql = "SELECT * FROM company WHERE password='$pass' AND id_company='$_SESSION[id_user]'";
	...
	if($result->num_rows > 0) {
		...
		$sql = "UPDATE company SET password='$password' WHERE password='$pass' AND id_company='$_SESSION[id_user]'";
