            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li><a href="jobs.php"><i class="fa fa-briefcase"></i> Active Jobs</a></li>
                  <li><a href="user.php"><i class="fa fa-address-book"></i> Candidates</a></li>
                  ...
                  <div class="info-box-content">
                    ...
                    <?php
                      ...
                      if($result->num_rows > 0) {
                          echo '<span class="info-box-number">'.$result->num_rows.'</span>';
                      }
                    ?>
                  </div>
                </div>                
                  ...
                  while($row = $result->fetch_assoc()) {
                    ?>
                      <tr>
                        ...
                        <td>
                          <a href="reject-company.php?id=<?php echo $row['id_company']; ?>"><i class="fa fa-times text-red"></i>   </a> &nbsp;&nbsp; &nbsp;
                          <a href="approve-company.php?id=<?php echo $row['id_company']; ?>"><i class="fa fa-check"></i></a></td>
                      </tr>
                    <?php
                  }
                }
